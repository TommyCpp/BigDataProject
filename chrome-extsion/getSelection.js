...
window.onmouseup = function (e) {
    ...
    if (window.getSelection() != null && window.getSelection().toString() !== "" && window.getSelection().toString().trim() !== "") {
        ...
        icon.setAttribute("style", `top: ${y - 10}px !important; left: ${x + 10}px !important; position:fixed;display:block;`);
        ...
        icon.onmouseover = function () {
            ...
            if (!location.ancestorOrigins.contains(extensionOrigin)) {
                ...
                iframe.src = chrome.runtime.getURL('frame.html?text=' + selectText);
